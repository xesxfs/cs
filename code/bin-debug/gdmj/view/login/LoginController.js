...
var LoginController = (function (_super) {
    ...
    LoginController.prototype.unRegister = function () {
    ...
    /**显示登录场景 */
    LoginController.prototype.runLoginScene = function () {
    ...
    /**IM登录请求 */
    LoginController.prototype.sendImLoginReq = function (token, uid) {
    ...
    /**IM登录返回 */
    LoginController.prototype.RevImLoginRev = function (data) {
        ...
        //清除弹窗
        var chooosePanel = App.PanelManager.getPanel(PanelConst.LoginChoosePanel);
        chooosePanel && chooosePanel.hide();
        var loginPanel = App.PanelManager.getPanel(PanelConst.LoginPanel);
        loginPanel && loginPanel.hide();
        this.revWxLoginReq(data);
    };
    /**独立包登录逻辑 */
    LoginController.prototype.independenceLogin = function () {
    ...
    LoginController.prototype.revWxLoginReq = function (result) {
        ...
        if (!rdata.ret) {
            ...
            if (App.DeviceUtils.IsNative) {
                ...
                var server = App.DataCenter.debugInfo.Sever;
                switch (server) {
                    case 1:
