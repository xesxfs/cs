...
var RulePanelH = (function (_super) {
    __extends(RulePanelH, _super);
    function RulePanelH() {
        var _this = _super.call(this) || this;
        _this.skinName = "RulePanelHSkin";
        return _this;
    }
    RulePanelH.prototype.childrenCreated = function () {
    };
    /** 添加到场景*/
    RulePanelH.prototype.onEnable = function () {
        if (this.gameBool) {
    ...
    /** 从场景中移除*/
    RulePanelH.prototype.onRemove = function () {
    ...
    /**初始化界面值 */
    RulePanelH.prototype.initView = function () {
        this.setContenText();
        this.addFileDoc();
        this.setJiHuFanType();
    };
    RulePanelH.prototype.addFileDoc = function () {
    ...
    RulePanelH.prototype.changeViewStack = function (event) {
        var group = event.target;
        this.jp_view_stack.selectedIndex = group.selectedValue;
    };
    /**关闭*/
    RulePanelH.prototype.onCloseBtn = function () {
        this.hide();
    };
    RulePanelH.prototype.setTxt = function (txt) {
     ...
     * 格式化内容文本
     */
    RulePanelH.prototype.setContenText = function () {
        //"fontFamily":"楷体"
     ...
     * 设置基本番型
     */
    RulePanelH.prototype.setJiHuFanType = function () {
...
__reflect(RulePanelH.prototype, "RulePanelH");
